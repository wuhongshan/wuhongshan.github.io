...
作为一个菜鸟前端，对于jquery还是相当喜欢的，初步入门，总是向着最容易的地方入手，对于jquery的优化知识了解不多，看到一篇文章写得很好，其实在“jquery权威指南”里面也有相关的讲解，jquery优化得好，速度可以快几倍，从现在开始学习并运用这些技巧非常有必要。下面转载一篇阮一峰的日志。
